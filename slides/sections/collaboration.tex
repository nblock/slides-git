...
\begin{frame}[fragile]{Git Repositories klonen}
  \begin{itemize}
    ...
    \begin{lstlisting}
$ git clone git://gitorious.org/valug/git-slides.git  #clone via git
$ git clone git@gitorious.org:valug/git-slides.git    #clone via ssh
$ git clone http://gitorious.org/valug/git-slides     #clone via http
    \end{lstlisting}
  \end{itemize}
\end{frame}
